...
public class clvnested extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.clvnested");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.clvnested.class).invoke(this, new Object[] {null});
        else
...
b4a.example3.customlistview _inner = null;
 //BA.debugLineNum = 77;BA.debugLine="Private Sub GetInnerCLVFromTouch (x As Float, Y As";
 //BA.debugLineNum = 78;BA.debugLine="Dim index As Int = CLV.FindIndexFromOffset(Y + CL";
_index = _clv._findindexfromoffset((int) (_y+_clv._sv.getScrollViewOffsetY()));
 //BA.debugLineNum = 79;BA.debugLine="Dim item As CLVItem = CLV.GetRawListItem(index)";
_item = _clv._getrawlistitem(_index);
 //BA.debugLineNum = 80;BA.debugLine="If item.Panel.GetView(0).Tag Is CustomListView Th";
if (_item.Panel.GetView((int) (0)).getTag() instanceof b4a.example3.customlistview) { 
 //BA.debugLineNum = 81;BA.debugLine="Dim inner As CustomListView = item.Panel.GetView";
_inner = (b4a.example3.customlistview)(_item.Panel.GetView((int) (0)).getTag());
 //BA.debugLineNum = 83;BA.debugLine="If inner.AsView.Left <= x And inner.AsView.Left";
...
public float  _getoffset(float _x,float _y) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Private Sub GetOffset (x As Float, y As Float) As";
 //BA.debugLineNum = 66;BA.debugLine="If ScrollingCLVHorizontal Then";
if (_scrollingclvhorizontal) { 
 //BA.debugLineNum = 67;BA.debugLine="Return x";
if (true) return _x;
 }else {
 //BA.debugLineNum = 69;BA.debugLine="Return y";
if (true) return _y;
 };
...
public boolean  _ishorizontalclv() throws Exception{
 //BA.debugLineNum = 73;BA.debugLine="Private Sub IsHorizontalCLV As Boolean";
 //BA.debugLineNum = 74;BA.debugLine="Return ScrollingCLV.sv Is HorizontalScrollView";
...
b4a.example3.customlistview _inner = null;
 //BA.debugLineNum = 50;BA.debugLine="Private Sub tpc_OnInterceptTouchEvent (Action As I";
 //BA.debugLineNum = 51;BA.debugLine="If Action = base.TOUCH_ACTION_DOWN Then";
if (_action==_base.TOUCH_ACTION_DOWN) { 
 //BA.debugLineNum = 52;BA.debugLine="Dim inner As CustomListView = GetInnerCLVFromTou";
_inner = _getinnerclvfromtouch(_x,_y);
 //BA.debugLineNum = 53;BA.debugLine="If inner <> Null Then";
if (_inner!= null) { 
 //BA.debugLineNum = 54;BA.debugLine="ScrollingCLV = inner";
_scrollingclv = _inner;
 //BA.debugLineNum = 55;BA.debugLine="ScrollingCLVHorizontal = IsHorizontalCLV";
_scrollingclvhorizontal = _ishorizontalclv();
 //BA.debugLineNum = 56;BA.debugLine="StartOffset = GetOffset(X, Y)";
_startoffset = _getoffset(_x,_y);
 //BA.debugLineNum = 57;BA.debugLine="Scrolled = False";
_scrolled = __c.False;
 //BA.debugLineNum = 58;BA.debugLine="ScrollPosition =  GetOffset(ScrollingCLV.sv.Scr";
...
b4a.example3.customlistview._clvitem _item = null;
 ...
 //BA.debugLineNum = 20;BA.debugLine="Select Action";
switch (BA.switchObjectToInt(_action,_base.TOUCH_ACTION_MOVE,_base.TOUCH_ACTION_UP)) {
case 0: {
 //BA.debugLineNum = 22;BA.debugLine="Dim deltaOffset As Float = (GetOffset(X, Y) - S";
_deltaoffset = (float) ((_getoffset(_x,_y)-_startoffset)*1.5);
 //BA.debugLineNum = 23;BA.debugLine="If Scrolled = False Then";
if (_scrolled==__c.False) { 
 //BA.debugLineNum = 24;BA.debugLine="If Abs(deltaOffset) > 10dip Then Scrolled = Tr";
if (__c.Abs(_deltaoffset)>__c.DipToCurrent((int) (10))) { 
_scrolled = __c.True;};
 };
 //BA.debugLineNum = 26;BA.debugLine="If Scrolled Then";
if (_scrolled) { 
 //BA.debugLineNum = 28;BA.debugLine="If ScrollingCLVHorizontal Then";
if (_scrollingclvhorizontal) { 
 //BA.debugLineNum = 29;BA.debugLine="ScrollingCLV.sv.ScrollViewOffsetX = ScrollPos";
_scrollingclv._sv.setScrollViewOffsetX((int) (_scrollposition-_deltaoffset));
 }else {
 //BA.debugLineNum = 31;BA.debugLine="ScrollingCLV.sv.ScrollViewOffsetY = ScrollPos";
_scrollingclv._sv.setScrollViewOffsetY((int) (_scrollposition-_deltaoffset));
 };
 };
 break; }
case 1: {
 //BA.debugLineNum = 35;BA.debugLine="If Scrolled = False Then";
if (_scrolled==__c.False) { 
 //BA.debugLineNum = 36;BA.debugLine="If ScrollingCLVHorizontal Then";
if (_scrollingclvhorizontal) { 
 //BA.debugLineNum = 37;BA.debugLine="Dim innerIndex As Int = ScrollingCLV.FindInde";
_innerindex = _scrollingclv._findindexfromoffset((int) (_x+_scrollingclv._sv.getScrollViewOffsetX()));
 }else {
 //BA.debugLineNum = 39;BA.debugLine="Dim index As Int = CLV.FindIndexFromOffset(St";
_index = _clv._findindexfromoffset((int) (_startoffset+_clv._sv.getScrollViewOffsetY()));
 //BA.debugLineNum = 40;BA.debugLine="Dim item As CLVItem = CLV.GetRawListItem(inde";
_item = _clv._getrawlistitem(_index);
 //BA.debugLineNum = 41;BA.debugLine="Dim innerIndex As Int = ScrollingCLV.FindInde";
_innerindex = _scrollingclv._findindexfromoffset((int) (_startoffset+_clv._sv.getScrollViewOffsetY()-_item.Offset+_scrollingclv._sv.getScrollViewOffsetY()));
 ...
 //BA.debugLineNum = 43;BA.debugLine="CallSub2(ScrollingCLV, \"Panel\" & \"ClickHandler";
__c.CallSubNew2(ba,(Object)(_scrollingclv),"Panel"+"ClickHandler",(Object)(_scrollingclv._getrawlistitem(_innerindex).Panel));
 };
 //BA.debugLineNum = 45;BA.debugLine="ScrollingCLV = Null";
_scrollingclv = (b4a.example3.customlistview)(__c.Null);
 break; }
}
;
 //BA.debugLineNum = 47;BA.debugLine="Return ScrollingCLV <> Null";
