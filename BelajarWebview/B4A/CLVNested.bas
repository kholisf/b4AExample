...
'	Log($"TOuch    1 tpc_OnTouchEvent (${Action} As Int, ${X} As Float, ${Y} As Float, ${MotionEvent }As Object)"$)
...
'	Log("TOuch    2 tpc_OnInterceptTouchEvent" &$"${Action} As Int, ${X} As Float, ${Y} As Float, ${MotionEvent } As Object"$)
