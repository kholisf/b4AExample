...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4ximageview.class, "_update" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4ximageview.class, "_updateclip" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
b4ximageview.__c.runVoidMethod ("LogImpl","930408731",RemoteObject.concat(RemoteObject.createImmutable("Invalid resize mode: "),__ref.getField(true,"_mresizemode" /*RemoteObject*/ )),0);
 break; }
}
;
