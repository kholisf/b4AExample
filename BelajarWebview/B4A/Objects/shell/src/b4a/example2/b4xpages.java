...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.example2.b4xpages");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("b4xpages"), "b4a.example2.b4xpages");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example2.b4xpages"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static RemoteObject _delegate = RemoteObject.declareNull("b4a.example2.b4xpagesdelegator");
...
public static b4a.example2.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example2.b4xcollections.class),"DateUtils",b4xpages.mostCurrent._dateutils,"Delegate",b4xpages._delegate,"GlobalContext",b4xpages._globalcontext,"HttpUtils2Service",Debug.moduleToString(b4a.example2.httputils2service.class),"Main",Debug.moduleToString(b4a.example2.main.class),"mPM",b4xpages._mpm,"Starter",Debug.moduleToString(b4a.example2.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example2.xuiviewsutils.class)};
}
}