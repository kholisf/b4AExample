...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_pivotindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_l,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(BA.numberCast(int.class, _i)));
 };
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(_l));
...
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_partition" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_length),(Object)(_pivotindex),(Object)(_comparator));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 25;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_quicksort" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_r),(Object)(_comparator));
 BA.debugLineNum = 26;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_quicksort" /*RemoteObject*/ ,(Object)(_data),(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,_r,RemoteObject.createImmutable(1)}, "++",2, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_length,_r,RemoteObject.createImmutable(1)}, "--",2, 1)),(Object)(_comparator));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcomparatorsort.class, "_quicksort" /*RemoteObject*/ ,(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(_data.runMethod(true,"getSize")),(Object)(_comparator));
