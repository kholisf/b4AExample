...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.example2.xuiviewsutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("xuiviewsutils"), "b4a.example2.xuiviewsutils");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example2.xuiviewsutils"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static b4a.example2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example2.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.example2.b4xpages.class),"DateUtils",xuiviewsutils.mostCurrent._dateutils,"HttpUtils2Service",Debug.moduleToString(b4a.example2.httputils2service.class),"Main",Debug.moduleToString(b4a.example2.main.class),"Starter",Debug.moduleToString(b4a.example2.starter.class),"UtilsInitialized",xuiviewsutils._utilsinitialized,"xui",xuiviewsutils._xui};
}
}