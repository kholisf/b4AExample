...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example2.b4xcombobox.class, "_raiseevent" /*void*/ );
...
Debug.JustUpdateDeviceLine();
_i = __ref.runClassMethod (b4a.example2.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("i", _i);Debug.locals.put("i", _i);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.example2.b4xcombobox.class, "_getitem" /*RemoteObject*/ ,(Object)(_i));
...
public ResumableSub_RaiseEvent(b4a.example2.b4xcombobox parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (b4a.example2.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("index", _index);Debug.locals.put("index", _index);
...
__ref.runClassMethod (b4a.example2.b4xcombobox.class, "_setselectedindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));};
