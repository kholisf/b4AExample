...
public static b4a.example2.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"ActionBarHomeClicked",main._actionbarhomeclicked,"Activity",main.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.example2.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.example2.b4xpages.class),"DateUtils",main.mostCurrent._dateutils,"HttpUtils2Service",Debug.moduleToString(b4a.example2.httputils2service.class),"imei",main._imei,"ph",main._ph,"rp",main._rp,"Starter",Debug.moduleToString(b4a.example2.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example2.xuiviewsutils.class)};
}
}