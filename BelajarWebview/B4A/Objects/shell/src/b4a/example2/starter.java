...
public static b4a.example2.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example2.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.example2.b4xpages.class),"DateUtils",starter.mostCurrent._dateutils,"HttpUtils2Service",Debug.moduleToString(b4a.example2.httputils2service.class),"Main",Debug.moduleToString(b4a.example2.main.class),"Service",starter.mostCurrent._service,"XUIViewsUtils",Debug.moduleToString(b4a.example2.xuiviewsutils.class)};
}
}