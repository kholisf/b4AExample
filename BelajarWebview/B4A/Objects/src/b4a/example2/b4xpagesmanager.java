...
public class b4xpagesmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example2.b4xpagesmanager");
            if (htSubs == null) {
...
public b4a.example2.b4xpagesmanager._b4amenuitem  _addmenuitem(Object _b4xpage,Object _title) throws Exception{
...
_findpifromb4xpage(_b4xpage).Parent /*b4a.example2.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
...
__c.LogImpl("910616835",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("910485781","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("910878980","Only top page can be closed",0);
...
__c.LogImpl("910878983","First page cannot be closed",0);
...
public String  _closepageimpl(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public boolean  _closerequestexists(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public b4a.example2.b4xpagesmanager._b4xpageinfo  _createb4xpageinfo(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
...
public b4a.example2.b4xpagesmanager._b4xpageparent  _createb4xpageparent(Object _nativetype) throws Exception{
...
public String  _createpageifneeded(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public String  _createpageimpl(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*b4a.example2.b4xpagesmanager._b4xpageparent*/  = _createb4xpageparent((Object)(_mmainform.getObject()));
...
public b4a.example2.b4xpagesmanager._b4xpageinfo  _findpifromb4xpage(Object _page) throws Exception{
b4a.example2.b4xpagesmanager._b4xpageinfo _pi = null;
...
public b4a.example2.b4xpagesmanager._b4xpageinfo  _getpagefromid(String _id) throws Exception{
b4a.example2.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (b4a.example2.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ ((Object)(_id.toLowerCase())));
 //BA.debugLineNum = 400;BA.debugLine="If pi = Null Then";
if (_pi== null) { 
 //BA.debugLineNum = 401;BA.debugLine="Log(\"Error: page id not found: \" & id)";
__c.LogImpl("911534339","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("911534340","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public b4a.example2.b4xpagesmanager._b4xpageinfo  _getpageinfofromroot(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (b4a.example2.b4xpagesmanager._b4xpageinfo)(_rootb4xtopage._get /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 409;BA.debugLine="End Sub";
return null;
}
public b4a.example2.b4xpagesmanager._b4xpageinfo  _gettoppage() throws Exception{
...
if (true) return (b4a.example2.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ (_mstackofpageids._aslist /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_mstackofpageids._getsize /*int*/ ()-1))));
 //BA.debugLineNum = 595;BA.debugLine="End Sub";
return null;
}
public void  _handlecloserequest(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
ResumableSub_HandleCloseRequest rsub = new ResumableSub_HandleCloseRequest(this,_pi);
rsub.resume(ba, null);
}
public static class ResumableSub_HandleCloseRequest extends BA.ResumableSub {
public ResumableSub_HandleCloseRequest(b4a.example2.b4xpagesmanager parent,b4a.example2.b4xpagesmanager._b4xpageinfo _pi) {
this.parent = parent;
this._pi = _pi;
}
...
__c.LogImpl("910420251","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
public String  _logevent(b4a.example2.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
public String  _raiseevent(b4a.example2.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
__c.LogImpl("912124174","Too many parameters",0);
 break; }
}
;
...
public Object  _raiseeventwithresult(b4a.example2.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
public String  _showpageimpl(b4a.example2.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
