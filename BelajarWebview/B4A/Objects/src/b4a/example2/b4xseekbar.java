...
public class b4xseekbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "b4a.example2.b4xseekbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example2.b4xseekbar.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(b4a.example2.b4xseekbar __ref,double _width,double _height) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "base_resize", true))
	 {return ((String) Debug.delegate(ba, "base_resize", new Object[] {_width,_height}));}
RDebugUtils.currentLine=36569088;
 //BA.debugLineNum = 36569088;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
RDebugUtils.currentLine=36569089;
 //BA.debugLineNum = 36569089;BA.debugLine="cvs.Resize(Width, Height)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Resize((float) (_width),(float) (_height));
RDebugUtils.currentLine=36569090;
 //BA.debugLineNum = 36569090;BA.debugLine="TouchPanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
RDebugUtils.currentLine=36569091;
 //BA.debugLineNum = 36569091;BA.debugLine="Vertical = mBase.Height > mBase.Width";
__ref._vertical /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()>__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth();
RDebugUtils.currentLine=36569092;
 //BA.debugLineNum = 36569092;BA.debugLine="size = Max(mBase.Height, mBase.Width) - 2 * Radiu";
...
RDebugUtils.currentLine=36569093;
 //BA.debugLineNum = 36569093;BA.debugLine="Update";
__ref._update /*String*/ (null);
RDebugUtils.currentLine=36569094;
 //BA.debugLineNum = 36569094;BA.debugLine="End Sub";
return "";
}
public String  _update(b4a.example2.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=36634626;
 //BA.debugLineNum = 36634626;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
RDebugUtils.currentLine=36634627;
 //BA.debugLineNum = 36634627;BA.debugLine="If size > 0 Then";
if (__ref._size /*int*/ >0) { 
RDebugUtils.currentLine=36634628;
 //BA.debugLineNum = 36634628;BA.debugLine="If Vertical = False Then";
if (__ref._vertical /*boolean*/ ==__c.False) { 
RDebugUtils.currentLine=36634629;
 //BA.debugLineNum = 36634629;BA.debugLine="Dim s1 As Int = Radius2 + (mValue - MinValue) /";
...
RDebugUtils.currentLine=36634630;
 //BA.debugLineNum = 36634630;BA.debugLine="Dim y As Int = mBase.Height / 2";
_y = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)2);
RDebugUtils.currentLine=36634631;
 //BA.debugLineNum = 36634631;BA.debugLine="cvs.DrawLine(Radius2, y, s1, y, Color1, Size1)";
...
RDebugUtils.currentLine=36634632;
 //BA.debugLineNum = 36634632;BA.debugLine="cvs.DrawLine(s1, y, mBase.Width - Radius2, y, C";
...
RDebugUtils.currentLine=36634633;
 //BA.debugLineNum = 36634633;BA.debugLine="cvs.DrawCircle(s1, y, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=36634634;
 //BA.debugLineNum = 36634634;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=36634635;
 //BA.debugLineNum = 36634635;BA.debugLine="cvs.DrawCircle(s1, y, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=36634638;
 //BA.debugLineNum = 36634638;BA.debugLine="Dim s1 As Int = Radius2 + (MaxValue - mValue) /";
...
RDebugUtils.currentLine=36634639;
 //BA.debugLineNum = 36634639;BA.debugLine="Dim x As Int = mBase.Width / 2";
_x = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)2);
RDebugUtils.currentLine=36634640;
 //BA.debugLineNum = 36634640;BA.debugLine="cvs.DrawLine(x, Radius2, x, s1, Color2, Size2)";
...
RDebugUtils.currentLine=36634641;
 //BA.debugLineNum = 36634641;BA.debugLine="cvs.DrawLine(x, s1, x, mBase.Height - Radius2,";
...
RDebugUtils.currentLine=36634642;
 //BA.debugLineNum = 36634642;BA.debugLine="cvs.DrawCircle(x, s1, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=36634643;
 //BA.debugLineNum = 36634643;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=36634644;
 //BA.debugLineNum = 36634644;BA.debugLine="cvs.DrawCircle(x, s1, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=36634648;
 //BA.debugLineNum = 36634648;BA.debugLine="cvs.Invalidate";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
RDebugUtils.currentLine=36634649;
 //BA.debugLineNum = 36634649;BA.debugLine="End Sub";
return "";
}
public String  _class_globals(b4a.example2.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=36372483;
 //BA.debugLineNum = 36372483;BA.debugLine="Public mBase As B4XView 'ignore";
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=36372484;
 //BA.debugLineNum = 36372484;BA.debugLine="Private xui As XUI 'ignore";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
RDebugUtils.currentLine=36372485;
 //BA.debugLineNum = 36372485;BA.debugLine="Public Color1, Color2, ThumbColor As Int";
_color1 = 0;
_color2 = 0;
_thumbcolor = 0;
RDebugUtils.currentLine=36372486;
 //BA.debugLineNum = 36372486;BA.debugLine="Private cvs As B4XCanvas";
_cvs = new anywheresoftware.b4a.objects.B4XCanvas();
RDebugUtils.currentLine=36372487;
 //BA.debugLineNum = 36372487;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=36372488;
 //BA.debugLineNum = 36372488;BA.debugLine="Private TouchPanel As B4XView";
_touchpanel = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=36372489;
 //BA.debugLineNum = 36372489;BA.debugLine="Private mValue As Int";
_mvalue = 0;
RDebugUtils.currentLine=36372490;
 //BA.debugLineNum = 36372490;BA.debugLine="Public MinValue, MaxValue As Int";
_minvalue = 0;
_maxvalue = 0;
RDebugUtils.currentLine=36372491;
 //BA.debugLineNum = 36372491;BA.debugLine="Public Interval As Int = 1";
_interval = (int) (1);
RDebugUtils.currentLine=36372492;
 //BA.debugLineNum = 36372492;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=36372493;
 //BA.debugLineNum = 36372493;BA.debugLine="Public Size1 = 4dip, Size2 = 2dip, Radius1 = 6dip";
...
RDebugUtils.currentLine=36372494;
 //BA.debugLineNum = 36372494;BA.debugLine="Private Pressed As Boolean";
_pressed = false;
RDebugUtils.currentLine=36372495;
 //BA.debugLineNum = 36372495;BA.debugLine="Private size As Int";
_size = 0;
RDebugUtils.currentLine=36372496;
 //BA.debugLineNum = 36372496;BA.debugLine="End Sub";
return "";
}
public String  _designercreateview(b4a.example2.b4xseekbar __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "designercreateview", true))
	 {return ((String) Debug.delegate(ba, "designercreateview", new Object[] {_base,_lbl,_props}));}
RDebugUtils.currentLine=36503552;
 //BA.debugLineNum = 36503552;BA.debugLine="Public Sub DesignerCreateView (Base As Object, Lbl";
RDebugUtils.currentLine=36503553;
 //BA.debugLineNum = 36503553;BA.debugLine="mBase = Base";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
RDebugUtils.currentLine=36503554;
 //BA.debugLineNum = 36503554;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._tag /*Object*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTag();
RDebugUtils.currentLine=36503554;
 //BA.debugLineNum = 36503554;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setTag(this);
RDebugUtils.currentLine=36503555;
 //BA.debugLineNum = 36503555;BA.debugLine="Color1 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=36503556;
 //BA.debugLineNum = 36503556;BA.debugLine="Color2 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=36503557;
 //BA.debugLineNum = 36503557;BA.debugLine="ThumbColor = xui.PaintOrColorToColor(Props.Get(\"T";
...
RDebugUtils.currentLine=36503558;
 //BA.debugLineNum = 36503558;BA.debugLine="Interval = Max(1, Props.GetDefault(\"Interval\", 1)";
...
RDebugUtils.currentLine=36503559;
 //BA.debugLineNum = 36503559;BA.debugLine="MinValue = Props.Get(\"Min\")";
__ref._minvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Min"))));
RDebugUtils.currentLine=36503560;
 //BA.debugLineNum = 36503560;BA.debugLine="MaxValue = Props.Get(\"Max\")";
__ref._maxvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Max"))));
RDebugUtils.currentLine=36503561;
 //BA.debugLineNum = 36503561;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, Props.Get(\"V";
...
RDebugUtils.currentLine=36503562;
 //BA.debugLineNum = 36503562;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=36503563;
 //BA.debugLineNum = 36503563;BA.debugLine="TouchPanel = xui.CreatePanel(\"TouchPanel\")";
...
RDebugUtils.currentLine=36503564;
 //BA.debugLineNum = 36503564;BA.debugLine="mBase.AddView(TouchPanel, 0, 0, mBase.Width, mBas";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .AddView((android.view.View)(__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(int) (0),(int) (0),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());
RDebugUtils.currentLine=36503565;
 //BA.debugLineNum = 36503565;BA.debugLine="If xui.IsB4A Or xui.IsB4i Then Radius2 = 20dip";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A() || __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4i()) { 
__ref._radius2 /*int*/  = __c.DipToCurrent((int) (20));};
RDebugUtils.currentLine=36503566;
 //BA.debugLineNum = 36503566;BA.debugLine="If xui.IsB4A Then Base_Resize(mBase.Width, mBase.";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A()) { 
__ref._base_resize /*String*/ (null,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());};
RDebugUtils.currentLine=36503567;
 //BA.debugLineNum = 36503567;BA.debugLine="End Sub";
return "";
}
public int  _getvalue(b4a.example2.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "getvalue", true))
	 {return ((Integer) Debug.delegate(ba, "getvalue", null));}
RDebugUtils.currentLine=36962304;
 //BA.debugLineNum = 36962304;BA.debugLine="Public Sub getValue As Int";
RDebugUtils.currentLine=36962305;
 //BA.debugLineNum = 36962305;BA.debugLine="Return mValue";
if (true) return __ref._mvalue /*int*/ ;
RDebugUtils.currentLine=36962306;
 //BA.debugLineNum = 36962306;BA.debugLine="End Sub";
return 0;
}
public String  _initialize(b4a.example2.b4xseekbar __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xseekbar";
...
public String  _raisetouchstateevent(b4a.example2.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=36765696;
 //BA.debugLineNum = 36765696;BA.debugLine="Private Sub RaiseTouchStateEvent";
RDebugUtils.currentLine=36765697;
 //BA.debugLineNum = 36765697;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_TouchS";
...
RDebugUtils.currentLine=36765698;
 //BA.debugLineNum = 36765698;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_TouchS";
...
public String  _setvalue(b4a.example2.b4xseekbar __ref,int _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "setvalue", true))
	 {return ((String) Debug.delegate(ba, "setvalue", new Object[] {_v}));}
RDebugUtils.currentLine=36896768;
 //BA.debugLineNum = 36896768;BA.debugLine="Public Sub setValue(v As Int)";
RDebugUtils.currentLine=36896769;
 //BA.debugLineNum = 36896769;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, v))";
__ref._mvalue /*int*/  = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=36896770;
 //BA.debugLineNum = 36896770;BA.debugLine="Update";
__ref._update /*String*/ (null);
RDebugUtils.currentLine=36896771;
 //BA.debugLineNum = 36896771;BA.debugLine="End Sub";
return "";
}
public String  _setvaluebasedontouch(b4a.example2.b4xseekbar __ref,int _x,int _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=36831232;
 //BA.debugLineNum = 36831232;BA.debugLine="Private Sub SetValueBasedOnTouch(x As Int, y As In";
RDebugUtils.currentLine=36831233;
 //BA.debugLineNum = 36831233;BA.debugLine="Dim v As Int";
_v = 0;
RDebugUtils.currentLine=36831234;
 //BA.debugLineNum = 36831234;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=36831235;
 //BA.debugLineNum = 36831235;BA.debugLine="v = (mBase.Height - Radius2 - y) / size * (MaxVa";
...
RDebugUtils.currentLine=36831237;
 //BA.debugLineNum = 36831237;BA.debugLine="v = (x - Radius2) / size * (MaxValue - MinValue)";
...
RDebugUtils.currentLine=36831239;
 //BA.debugLineNum = 36831239;BA.debugLine="v = Round (v / Interval) * Interval";
_v = (int) (__c.Round(_v/(double)__ref._interval /*int*/ )*__ref._interval /*int*/ );
RDebugUtils.currentLine=36831240;
 //BA.debugLineNum = 36831240;BA.debugLine="Dim NewValue As Int = Max(MinValue, Min(MaxValue,";
_newvalue = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=36831241;
 //BA.debugLineNum = 36831241;BA.debugLine="If NewValue <> mValue Then";
if (_newvalue!=__ref._mvalue /*int*/ ) { 
RDebugUtils.currentLine=36831242;
 //BA.debugLineNum = 36831242;BA.debugLine="mValue = NewValue";
__ref._mvalue /*int*/  = _newvalue;
RDebugUtils.currentLine=36831243;
 //BA.debugLineNum = 36831243;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Value";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .SubExists(ba,__ref._mcallback /*Object*/ ,__ref._meventname /*String*/ +"_ValueChanged",(int) (1))) { 
RDebugUtils.currentLine=36831244;
 //BA.debugLineNum = 36831244;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Value";
...
public String  _touchpanel_touch(b4a.example2.b4xseekbar __ref,int _action,float _x,float _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=36700160;
 //BA.debugLineNum = 36700160;BA.debugLine="Private Sub TouchPanel_Touch (Action As Int, X As";
RDebugUtils.currentLine=36700161;
 //BA.debugLineNum = 36700161;BA.debugLine="If Action = TouchPanel.TOUCH_ACTION_DOWN Then";
...
RDebugUtils.currentLine=36700162;
 //BA.debugLineNum = 36700162;BA.debugLine="Pressed = True";
__ref._pressed /*boolean*/  = __c.True;
RDebugUtils.currentLine=36700163;
 //BA.debugLineNum = 36700163;BA.debugLine="RaiseTouchStateEvent";
__ref._raisetouchstateevent /*String*/ (null);
RDebugUtils.currentLine=36700164;
 //BA.debugLineNum = 36700164;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=36700165;
 //BA.debugLineNum = 36700165;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_MOVE The";
...
RDebugUtils.currentLine=36700166;
 //BA.debugLineNum = 36700166;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=36700167;
 //BA.debugLineNum = 36700167;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_UP Then";
if (_action==__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .TOUCH_ACTION_UP) { 
RDebugUtils.currentLine=36700168;
 //BA.debugLineNum = 36700168;BA.debugLine="Pressed = False";
__ref._pressed /*boolean*/  = __c.False;
RDebugUtils.currentLine=36700169;
 //BA.debugLineNum = 36700169;BA.debugLine="RaiseTouchStateEvent";
__ref._raisetouchstateevent /*String*/ (null);
 }}}
;
RDebugUtils.currentLine=36700171;
 //BA.debugLineNum = 36700171;BA.debugLine="Update";
__ref._update /*String*/ (null);
