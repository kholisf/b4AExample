...
if (true) return _getmanager(_ba)._addmenuitem /*b4a.example2.b4xpagesmanager._b4amenuitem*/ (_b4xpage,_title);
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.example2.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*b4a.example2.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ ;
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.example2.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
_delegate = new b4a.example2.b4xpagesdelegator();
